    ...
    public class UserController : Controller
    {
        ...
        public ReturnObj Recharge(string account, string code, double money)
        {
            ...
            try
            {
                ...
                returnObj.SetIsSuccess(userService.Recharge(user, code, money));
            }
            catch (Exception)
            {
                returnObj.SetIsSuccess(false);
        ...
        /// <param name="money"></param>
        /// <returns></returns>
        public ReturnObj BuyVIP(string account,string money)
        {
            ReturnObj returnObj = new ReturnObj();
            try
            {
                User user = userService.GetUser(account);
                returnObj.SetIsSuccess(userService.BuyVIP(user, money));
            }
            catch (Exception)
            {
                returnObj.SetIsSuccess(false);
